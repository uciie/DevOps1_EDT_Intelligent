  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      try {
        ...
        // FIX : la ligne précédente référençait 'updatedUser' qui n'existe pas.
        // Le localStorage contient déjà les données de connexion initiale ;
        // le champ googleRefreshToken est côté backend uniquement.
        // SetupPage refetch les données fraîches via GET /users/username/{...}
        // donc rien à mettre à jour ici.
